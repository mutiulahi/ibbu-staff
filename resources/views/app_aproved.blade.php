                                            ...
                                            <tbody> 
                                                ...
                                                @foreach ($applications as $staff_application)
                                                    <tr>
                                                        <td>{{$count++}}</td>
                                                        <td>
                                                            <button type="button" class="btn btn-secondary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-sm{{$staff_application->PFN}}details"><i class="fas fa-eye"></i></button>
                                                        </td>
