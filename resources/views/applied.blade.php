...
<html lang="en"> 
 <head> 
        <title>Applications | IBBUL - Staff Admin Record</title> 
        <!-- App favicon -->
                                                                            ...
                                                                            <form action="{{route('accept_app')}}" method="post">
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <div class="input-group auth-pass-inputgroup">
                                                                                        <input type="number" class="form-control" min="0" name="grade" placeholder="CONUASS / CONTISS" required>
                                                                                    </div>
                                                                                    <br>
                                                                                    <div class="input-group auth-pass-inputgroup">
                                                                                        <input type="number" class="form-control" min="0" name="step" placeholder="Step" required>
                                                                                    </div>
                                                                                </div> 
                                                                                <div class="mb-3">
